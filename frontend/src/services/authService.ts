import { LoginFormData, UserDisplayName, ResponseLoginAuthDto } from '@/types/auth';

const API_URL = process.env.NEXT_PUBLIC_API_URL;

export const authService = {
    async login(credentials: LoginFormData): Promise<ResponseLoginAuthDto> { // เปลี่ยน return type เป็น ResponseLoginAuthDto
        try {
    ...
    saveTokens(accessToken: string): void { // รับเฉพาะ accessToken
