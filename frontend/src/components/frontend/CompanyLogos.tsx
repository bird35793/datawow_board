    ...
    <section className="py-12 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-600">
          มากกว่า 3,500 บริษัทในปี 2024 ที่ลงประกาศรับสมัครงาน ตำแหน่งฝึกงาน
          กับเรา และอัพเดทเพิ่มขึ้นอย่างต่อเนื่องในทุก ๆ วัน
        </p>
        <p className="text-center text-gray-600 mb-12">
          เรายังคงมุ่งมั่นพัฒนาระบบ เพื่อส่งมอบประสบการณ์การใช้งานที่ดีที่สุด
          ให้กับผู้ใช้งานของเราเสมอ
        </p>
